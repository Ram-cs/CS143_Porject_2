...
time.data <- read.csv("/Users/michael/vm-shared_2/CS143_Porject_2/Pro2B/all_days.csv/time_data.csv", stringsAsFactors=FALSE)
...
library(dplyr)
library(maps)
state.data <- read.csv("/Users/michael/vm-shared_2/CS143_Porject_2/Pro2B/all_states.csv/state_data.csv", header=TRUE)
...
story.data <- read.csv("/Users/michael/vm-shared_2/CS143_Porject_2/Pro2B/all_submission_score.csv/submission_score.csv", quote="", header=TRUE)
...
comment.data <- read.csv("/Users/michael/vm-shared_2/CS143_Porject_2/Pro2B/all_comment_score.csv/comment_score.csv", quote="", header=TRUE)
